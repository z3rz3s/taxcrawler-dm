...
def _build_month_calcs(income_recs: list[dict], expense_recs: list[dict],
                       isr_table: list[tuple]) -> dict:
    """
    Calcula IVA e ISR para un mes dado.
    isr_retenido se extrae de los propios registros de ingresos si estuviera
    disponible — por ahora el Metadata basico no lo trae, se deja en 0.
    TODO: extraer isr_retenido del XML cuando se implemente xml_parser.
    """
    ...
    isr_retenido    = 0.0  # TODO: leer del XML cuando este disponible
